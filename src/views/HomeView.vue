...
const validateReason = (blur) => {
  if (formData.value.reason.length < 10) {
    ...
    if (formData.value.reason.toLowerCase().includes('friend')) {
      document.querySelector('#friend-message').style.display = 'block';
    } else {
      document.querySelector('#friend-message').style.display = 'none';
    }
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            ></textarea>
            <div id="friend-message" class="text-success" style="display: none;">
